...
function MasterManagement({
  ...
  const categoryAbbrevOptions = {
    skincare: ['QS', 'QS(PF', 'P', 'LI', 'LII', 'Lｾﾙ', 'ESI', 'ESII', 'ESｾﾙ', 'ESﾏｽｸ', 'MB', 'ｾﾙｾﾗﾑ', 'ｴｽ', 'ｾﾙｼﾞｪﾙ', 'MJ', 'APｿｰﾌﾟ', 'APｽｷﾝS', 'APｽｷﾝL', 'APｽｷﾝC', 'set3Ⅰ', 'set3Ⅱ', 'set3ｾﾙ', 'B4Ⅰ', 'B4Ⅱ', 'B4ｾﾙ', 'other'],
    baseMakeup: ['下地NP', '下地SP', '下地MP', 'ﾘｷｯﾄﾞ01', 'ﾘｷｯﾄﾞ02', 'ﾘｷｯﾄﾞ03', 'ﾘｷｯﾄﾞ04', 'ﾘｷｯﾄﾞ05', 'ｳﾞｪｰﾙ11', 'ｳﾞｪｰﾙ12', 'ｳﾞｪｰﾙ13', 'ｳﾞｪｰﾙ14', 'PF21', 'PF22', 'PF23', 'PF24', 'PF25', 'PF21(R', 'PF22(R', 'PF23(R', 'PF24(R', 'PF25(R', 'FP', 'FP(R', 'PP', 'PP(R', 'ｽﾎﾟﾝｼﾞ', 'ﾊﾟﾌ', 'ﾊﾟﾌLFP', 'ﾊﾟﾌPFP', 'ﾊﾟﾌLPP', 'other'],
    hairBodyCare: ['ｼｬﾝﾌﾟｰ', 'ｼｬﾝﾌﾟｰ(R', 'ｺﾝﾃﾞｨ', 'ｺﾝﾃﾞｨ(R', 'EXｼｬﾝﾌﾟ', 'EXｼｬﾝ(R', 'EXﾄﾘｰﾄ', 'ﾍｱﾐｽﾄ', 'ﾄﾘｰﾄｵｲﾙ', 'ｽｶﾙﾌﾟL', 'ｽｶﾙﾌﾟES', 'ﾊﾞｽPW', 'Bｿｰﾌﾟ', 'Bｿｰﾌﾟ(R', 'Bﾐｽﾄ', 'ｱﾋﾟﾌﾞﾗｼ', 'しらきぬ', 'other'],
    healthcare: ['酵素', '酵素+R', '酵素+L', '酵素G', 'EX10', 'EX30', '霊芝R', '霊芝L', 'AG', 'ﾘﾅｶﾝ茶', 'ｵﾒｶﾞ3', 'ｼﾅﾔｶR', 'ｼﾅﾔｶL', 'ﾋﾞｴｯｾS', 'ﾋﾞｴｯｾEX', 'Fe', 'ｸﾘｱｰ', 'ﾐﾈﾗﾙ+', 'ｾﾙｴﾅｼﾞV', 'ﾘﾅｶﾝC', 'ﾋﾟｭｱCa', 'other'],
    pointMakeup: [
      'ｼｪｰﾄﾞC201', 'ｼｪｰﾄﾞC202', 'ｼｪｰﾄﾞC203', 'ｼｪｰﾄﾞN204', 'ｼｪｰﾄﾞN205', 'ｼｪｰﾄﾞN206', 'ｼｪｰﾄﾞW207', 'ｼｪｰﾄﾞW208', 'ｼｪｰﾄﾞW209', 'ｼｪｰﾄﾞC210', 'ｼｪｰﾄﾞC211', 'ｼｪｰﾄﾞN212', 'ｼｪｰﾄﾞN213', 'ｼｪｰﾄﾞW214', 'ｼｪｰﾄﾞW215',
      'ﾁｰｸC401', 'ﾁｰｸN402', 'ﾁｰｸW403', 'ﾁｰｸC404', 'ﾁｰｸN405', 'ﾁｰｸN406',
      'ﾘｯﾌﾟC701', 'ﾘｯﾌﾟC702', 'ﾘｯﾌﾟC703', 'ﾘｯﾌﾟN704', 'ﾘｯﾌﾟN705', 'ﾘｯﾌﾟN706', 'ﾘｯﾌﾟW707', 'ﾘｯﾌﾟW708', 'ﾘｯﾌﾟW709', 'ﾘｯﾌﾟ80',
      'ﾘｯﾌﾟｺｰﾄ', 'ｸﾞﾛｽ', '眉ﾎﾙﾀﾞｰ', '眉(茶)', '眉(黒)', '眉PW', '眉PWﾘﾌｨﾙ',
      'ｱｲﾗｲﾝﾎﾙﾀﾞｰ', 'ｱｲﾗｲﾝ(茶)', 'ｱｲﾗｲﾝ(黒)', 'ﾘｷｯﾄﾞｱｲﾗｲﾝ', 'ﾏｽｶﾗ', '眉ﾌﾞﾗｼ', 'ﾘｯﾌﾟﾌﾞﾗｼ', 'MO', 'other'
    ],
    other: ['ﾌﾗﾜｰ', 'ﾊﾟﾚｯﾄR', 'other']
  };
